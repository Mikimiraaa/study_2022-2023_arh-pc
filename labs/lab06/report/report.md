...
![Исполняемый файл](image/51.png){ #fig:015 width=70% }
...
𝑥, вычисляет заданное выражение в зависимости от введенного 𝑥, выводит результат вычислений. Вид функции 𝑓(𝑥) выбрали из таблицы 6.3
вариантов заданий, наш номер - 18, полученный при выполнении лабораторной работы. Создали исполняемый файл и проверили его
работу для значений 𝑥1 = 1 и 𝑥2 = 5 из 6.3. 
